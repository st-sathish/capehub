...
public class Activator implements BundleActivator {
	...
	*/
	...
	public void start(BundleContext bundleContext) throws Exception {
	    ...
	    rootDir = bundleContext.getProperty("com.capehub.storage.dir") + File.separator + "db";
	    // Register the Datasource, defaulting to an embedded H2 database if DB configurations are not specified
	    String vendor = getConfigProperty(bundleContext.getProperty("com.capehub.db.vendor"), "HSQL");
	    String jdbcDriver = getConfigProperty(bundleContext.getProperty("com.capehub.db.jdbc.driver"),
	            "org.h2.Driver");
	    ...
	    if ("true".equalsIgnoreCase(bundleContext.getProperty("com.capehub.db.ddl.generation"))) {
	    	props.put("eclipselink.ddl-generation", "create-tables");
	    	if ("true".equalsIgnoreCase(bundleContext.getProperty("com.capehub.db.ddl.script.generation"))) {
