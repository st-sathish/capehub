package com.capestart.util.data.functions;

import com.capestart.util.data.Effect;
import com.capestart.util.data.Effect0;
import com.capestart.util.data.Effect2;
import com.capestart.util.data.Either;
import com.capestart.util.data.Function;
import com.capestart.util.data.Function0;
import com.capestart.util.data.Function2;
import com.capestart.util.data.Option;
import com.capestart.util.data.Predicate;
import com.capestart.util.data.Tuple;

import java.util.List;
import java.util.Map;

import static com.capestart.util.data.Either.left;
import static com.capestart.util.data.Either.right;
import static com.capestart.util.data.Monadics.mlist;
import static com.capestart.util.data.Option.option;
