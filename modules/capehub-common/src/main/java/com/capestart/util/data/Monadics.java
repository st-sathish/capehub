...
import static com.capestart.util.data.Collections.appendTo;
import static com.capestart.util.data.Collections.appendToA;
import static com.capestart.util.data.Collections.appendToM;
import static com.capestart.util.data.Collections.forc;
import static com.capestart.util.data.Collections.iterator;
import static com.capestart.util.data.Collections.list;
import static com.capestart.util.data.Collections.toList;
import static com.capestart.util.data.Option.none;
import static com.capestart.util.data.Option.some;
import static com.capestart.util.data.Prelude.unexhaustiveMatch;
