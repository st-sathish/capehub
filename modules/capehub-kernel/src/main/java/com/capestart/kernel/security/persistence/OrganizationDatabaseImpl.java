...
public class OrganizationDatabaseImpl implements OrganizationDatabase {
  ...
  public void setSecurityService(SecurityService securityService) {
    this.securityService = securityService;
  	...
  	/**
	 * @see com.capestart.kernel.security.persistence.OrganizationDatabase#deleteOrganization(java.lang.String)
	 */
  @Override
  public void deleteOrganization(String orgId) throws OrganizationDatabaseException, NotFoundException {
    ...
    try {
  	...
  	/**
	 * @see com.capestart.kernel.security.persistence.OrganizationDatabase#storeOrganization(org.opencastproject.security.api.Organization)
	 */
  @Override
  public void storeOrganization(Organization org) throws OrganizationDatabaseException {
    ...
    try {
  	...
  	/**
	 * @see com.capestart.kernel.security.persistence.OrganizationDatabase#getOrganization(java.lang.String)
	 */
  @Override
  public Organization getOrganization(String id) throws NotFoundException, OrganizationDatabaseException {
    ...
    try {
  	...
  	/**
	 * @see com.capestart.kernel.security.persistence.OrganizationDatabase#countOrganizations()
	 */
  @Override
  ...
  /**
   * @see com.capestart.kernel.security.persistence.OrganizationDatabase#getOrganizations()
   */
  @Override
  ...
  public List<Organization> getOrganizations() throws OrganizationDatabaseException {
    ...
    try {
  	...
  	/**
	 * @see com.capestart.kernel.security.persistence.OrganizationDatabase#containsOrganization(String)
	 */
  @Override
