...
import com.capestart.rest.StaticResource;
import com.capestart.security.api.UnauthorizedException;
import com.capestart.systems.CapehubConstans;
...
public class RestPublisher implements RestConstants {
  ...
  /** The rest publisher looks for any non-servlet with the 'capehub.service.path' property */
  ...
  protected void activate(ComponentContext componentContext) {
    ...
    this.baseServerUri = componentContext.getBundleContext().getProperty(CapehubConstans.SERVER_URL_PROPERTY);
    ...
    JSONProvider jsonProvider = new CapehubJSONProvider();
   ...
   */
  protected static class CapehubJSONProvider extends JSONProvider {
