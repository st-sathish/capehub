...
import static com.capestart.util.data.Collections.map;
import static com.capestart.util.data.Collections.toList;
import static com.capestart.util.data.Tuple.tuple;
import static com.capestart.security.util.SecurityUtil.hostAndPort;

import com.capestart.kernel.security.persistence.JpaOrganization;
...
public class OrganizationDirectoryServiceImpl implements OrganizationDirectoryService, ManagedServiceFactory {
	...
	public static final String PID = "com.capestart.organization";
	 ...
	 // Load the existing organization or create a new one
	    try {
	    	...
	    	try {
	    		...
	    		org = new JpaOrganization(id, name, server, port, adminRole, orgProperties);
