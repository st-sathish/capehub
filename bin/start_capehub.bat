...
SET FELIX_HOME=F:\development\workspace1\capehub
SET M2_HOME=F:\Environment\apache-maven-3.3.3
...
SET CAPEHUB_LOGDIR=%FELIX_HOME%\logs
...
SET PAX_LOGGING_OPTS=-Dorg.ops4j.pax.logging.DefaultServiceLog.level=INFO -Dcapehub.logdir="%CAPEHUB_LOGDIR%"
...
REM # Make sure capehub bundles are reloaded
